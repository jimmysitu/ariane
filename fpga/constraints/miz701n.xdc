...
## Debug
set_property -dict { PACKAGE_PIN {N17} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[8]}]
set_property -dict { PACKAGE_PIN {P18} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[0]}]
set_property -dict { PACKAGE_PIN {W18} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[9]}]
set_property -dict { PACKAGE_PIN {W19} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[1]}]
set_property -dict { PACKAGE_PIN {Y18} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[10]}]
set_property -dict { PACKAGE_PIN {Y19} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[2]}]
set_property -dict { PACKAGE_PIN {V17} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[11]}]
set_property -dict { PACKAGE_PIN {V18} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[3]}]
set_property -dict { PACKAGE_PIN {R16} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[12]}]
set_property -dict { PACKAGE_PIN {R17} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[4]}]
set_property -dict { PACKAGE_PIN {P15} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[13]}]
set_property -dict { PACKAGE_PIN {P16} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[5]}]
set_property -dict { PACKAGE_PIN {V15} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[14]}]
set_property -dict { PACKAGE_PIN {W15} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[6]}]
set_property -dict { PACKAGE_PIN {T16} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[15]}]
set_property -dict { PACKAGE_PIN {U17} IOSTANDARD {LVCMOS33}} [get_ports {dbg_o[7]}]
